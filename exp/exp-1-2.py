...
task_id = int(sys.argv[1]) # from 0 to 49
num_tasks = int(sys.argv[2]) # should be 5 * 10 = 50
assert num_tasks == 50
...
torch.save({
    ...
    'eval_losses': eval_losses}, f'../../../orcd/pool/MultiHeads/outputs/exp-1-2-{task_id}.pt')